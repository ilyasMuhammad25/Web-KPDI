...
<section class="big-section fix-background overlap-height">
    <div class="opacity-full bg-corporate-primary"></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-4 text-center margin-35px-top overlap-gap-section sm-no-margin-top">
                <a href="<?=get_parameter('site-video')?>" class="video-popup-link video-icon-box video-icon-large text-center position-relative">
                    <span>
