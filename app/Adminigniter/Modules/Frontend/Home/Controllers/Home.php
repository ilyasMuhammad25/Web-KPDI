...
namespace App\Adminigniter\Modules\Frontend\Home\Controllers;
...
class Home extends \hamkamannan\adminigniter\Controllers\BaseController
{
	...
	public function index()
	{
		...
		echo view(APPPATH.'Adminigniter/Modules/Frontend/Home/Views/index', $this->data);
	}
	...
	public function datatables()
	{
		...
		echo view(APPPATH.'Modules/Frontend/Home/Views/datatables', $this->data);
	}

	public function json()
	{
		$data = DataTables::use('c_params')
			->make(true);
