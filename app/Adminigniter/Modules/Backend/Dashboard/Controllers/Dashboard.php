...
class Dashboard extends \hamkamannan\adminigniter\Controllers\BaseController
{
    ...
    public function highlight()
    {
        ...
        echo view('\App\Adminigniter\Modules\Backend\Dashboard\Views\highlight', $this->data);
    }
    ...
    public function roadmap()
    {
        ...
        echo view('\App\Adminigniter\Modules\Backend\Dashboard\Views\roadmap', $this->data);
    }
}
