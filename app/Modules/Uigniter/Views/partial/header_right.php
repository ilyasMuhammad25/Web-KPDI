            ...
            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-plum-plate">
                        <div class="menu-header-image" style="background-image: url('<?= base_url('uigniter'); ?>/assets/images/dropdown-header/abstract4.jpg');"></div>
        ...
        <div class="dropdown">
            <button type="button" data-toggle="dropdown" class="p-0 mr-2 btn btn-link">
                <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                    ...
                    <span class="language-icon opacity-8 flag large ID"></span>
                </span>
            </button>
            <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu dropdown-menu-right">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                        <div class="menu-header-image opacity-05" style="background-image: url('<?= base_url('uigniter'); ?>/assets/images/dropdown-header/city2.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-love-kiss">
                                    <div class="menu-header-image opacity-2" style="background-image: url('<?= base_url('uigniter'); ?>/assets/images/dropdown-header/city3.jpg');"></div>
                                    <div class="menu-header-content text-left">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading text-light">Hamka Mannan
                                                    </div>
                                                    <div class="widget-subheading opacity-8 text-light">Adminigniter
                                                    </div>
                                                </div>
                                                <div class="widget-content-right mr-2">
                                                    <a class="btn btn-pill btn-danger" href="#">Logout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="scroll-area-xs" style="height: 150px;">
                                <div class="scrollbar-container ps">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a href="<?= base_url('uigniter/view_profile'); ?>" class="nav-link">My Profile
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?= base_url('uigniter/change_password'); ?>" class="nav-link">Change Password
                                            </a>
                                        </li>
                                        <li class="nav-item-header nav-item">Groups</li>
                                        <li class="nav-item-header nav-item">
                                                <a href="#" class="ml-0 mb-2 badge badge-secondary">Group1
                                                </a>
                                                <a href="#" class="ml-0 mb-2 badge badge-secondary">Group2
                                                </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="no-gutters row">
                                        <div class="col-sm-6">
                                            <button class="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-warning">
                                                <i class="pe-7s-display1 icon-gradient bg-amy-crisp btn-icon-wrapper mb-2"></i>
                                                Dashboard
                                            </button>
                                        </div>
                                        <div class="col-sm-6">
