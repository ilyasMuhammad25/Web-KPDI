...
<div class="app-main__inner">
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <li class="nav-item">
            <a href="<?= base_url('uigniter/dashboards/minimal'); ?>" class="nav-link active">
                <span>Variation 1</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= base_url('uigniter/dashboards/minimal_variation') ?>" class="nav-link">
                ...
                <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center" style="width: 80px;"><img width="40" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/4.jpg" alt=""></td>
                        ...
                        <tr>
                            <td class="text-center text-muted" style="width: 80px;">#56</td>
                            <td class="text-center" style="width: 80px;">
                                <img width="40" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt="">
                            </td>
