            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="main-card mb-3 card">
                        ...
                        <div class="card-body">Some quick example text to build on the card title and make up the bulk of the card's content.<a href="javascript:void(0);" class="card-link">Card Link</a><a href="javascript:void(0);" class="card-link">Another
                                Link</a></div>
                    </div>
                    <div class="main-card mb-3 card"><img width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&amp;txt=318%C3%97180&amp;w=318&amp;h=180" alt="Card image cap" class="card-img-top">
                        <div class="card-body">
