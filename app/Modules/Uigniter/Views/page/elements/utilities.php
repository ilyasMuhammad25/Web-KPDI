            ...
            <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-mean-fruit">
                                        <div class="menu-header-image" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract2.jpg');"></div>
                            ...
                            <div class="col-md-3">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-amy-crisp">
                                        <div class="menu-header-image" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract3.jpg');"></div>
                                        <div class="menu-header-content">
                                            <div>
                                                <h5 class="menu-header-title">Settings</h5>
                                                <h6 class="menu-header-subtitle">Manage all of your options</h6>
                            ...
                            <div class="col-md-3">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-arielle-smile">
                                        <div class="menu-header-image" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract4.jpg');"></div>
                                        <div class="menu-header-content">
                                            <div>
                                                <h5 class="menu-header-title">Settings</h5>
                                                <h6 class="menu-header-subtitle">Manage all of your options</h6>
                            ...
                            <div class="col-md-3">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-grow-early">
                                        <div class="menu-header-image" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract5.jpg');"></div>
                                        <div class="menu-header-content">
                                            <div>
                                                <h5 class="menu-header-title">Settings</h5>
                                                <h6 class="menu-header-subtitle">Manage all of your options</h6>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract1.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract2.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract3.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract4.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract5.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract6.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract7.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract8.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract9.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/abstract10.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/city1.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/city2.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/city3.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/city4.jpg');"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="demo-image-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/sidebar/city5.jpg');"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning fade show" role="alert">
                    ...
                    <p class="mb-0">All Bootstrap 4 helper classes available in the official Bootstrap documentation are also available in UIgniter Framework: Spacing, resets, typography utilities, sizing and others.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="main-card mb-3 card">
