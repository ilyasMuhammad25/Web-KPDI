                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                        ...
                                        <li class="nav-item">
                                            <a role="tab" class="nav-link" href="<?= base_url('uigniter/forgot_password'); ?>">
                                                <span>Forgot Password</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a role="tab" class="nav-link active" href="<?= base_url('uigniter/forgot_password_boxed') ?>">
                                    ...
                                    <h6 class="mb-0"><a href="<?= base_url('uigniter/login_boxed'); ?>" class="text-primary">Sign in existing account</a></h6>
                                </div>
