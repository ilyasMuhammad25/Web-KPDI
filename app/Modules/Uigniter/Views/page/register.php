                    ...
                    <div class="h-100 d-md-flex d-sm-block bg-white justify-content-center align-items-center col-md-12 col-lg-7">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                ...
                                <li class="nav-item">
                                    <a role="tab" class="nav-link active" href="<?= base_url('uigniter/register'); ?>">
                                        <span>Register</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a role="tab" class="nav-link" href="<?= base_url('uigniter/register_boxed') ?>">
                            ...
                            <div>
                                <form class="">
                                    ...
                                    <div class="mt-4 d-flex align-items-center">
                                        <h5 class="mb-0">Already have an account? <a href="<?= base_url('uigniter/login') ?>" class="text-primary">Sign in</a></h5>
                                        <div class="ml-auto">
