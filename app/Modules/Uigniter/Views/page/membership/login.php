        ...
        <div class="h-100 no-gutters row">
            ...
            <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                    ...
                    <h6 class="mt-3">No account? <a href="<?= base_url('uigniter/membership/register') ?>" class="text-primary">Sign up now</a></h6>
                    ...
                    <div>
                        <form class="">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="ml-auto"><a href="<?= base_url('uigniter/membership/forgot_password') ?>" class="btn-lg btn btn-link">Recover Password</a>
