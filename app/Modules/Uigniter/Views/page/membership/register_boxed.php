                ...
                <div class="modal-dialog w-100">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h6 class="mb-0">Already have an account? <a href="<?= base_url('uigniter/membership/login_boxed'); ?>" class="text-primary">Sign in</a> | <a href="<?= base_url('uigniter/membership/forgot_password_boxed'); ?>" class="text-primary">Recover Password</a></h6>
                        </div>
