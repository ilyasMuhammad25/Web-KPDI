        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Commerce Dashboard
                    <div class="page-title-subheading">This dashboard was created as an example of the flexibility that UIgniter offers.</div>
                </div>
            </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-3">
                                                    <img width="38" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/10.jpg" alt="">
                                                </div>
                                                <div class="widget-content-left">
                                    ...
                                    <li class="border-bottom-0 list-group-item">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-3">
                                                    <img width="38" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/9.jpg" alt="">
                                                </div>
                                                <div class="widget-content-left">
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="32" class="rounded" src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt="">
                                            </div>
                                        </div>
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="32" class="rounded" src="<?= base_url('themes/uigniter'); ?>/images/avatars/2.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="32" class="rounded" src="<?= base_url('themes/uigniter'); ?>/images/avatars/3.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="32" class="rounded" src="<?= base_url('themes/uigniter'); ?>/images/avatars/4.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
                <div class="card-shadow-primary card-border mb-3 card">
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-primary">
                            <div class="menu-header-image opacity-4" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/dropdown-header/abstract2.jpg');"></div>
                            <div class="menu-header-content">
                ...
                <div class="card-shadow-primary card-border mb-3 profile-responsive-sm card">
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-vicious-stance">
                            <div class="menu-header-image opacity-1" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/dropdown-header/abstract1.jpg');"></div>
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded-circle"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt="Avatar 5"></div>
                                </div>
                                <div>
