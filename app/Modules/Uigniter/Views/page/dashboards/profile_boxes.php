                    ...
                    <div class="dropdown-menu-header-inner bg-success">
                        <div class="menu-header-content">
                            <div class="avatar-icon-wrapper btn-hover-shine mb-2 avatar-icon-xl">
                                <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt="Avatar 6"></div>
                            </div>
                            <div>
                            ...
                            <ul class="list-group list-group-flush">
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left"><img width="52" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/2.jpg" alt=""></div>
                                            </div>
                                ...
                                <li class="list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left"><img width="52" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/8.jpg" alt=""></div>
                                            </div>
                                            <div class="widget-content-left flex2">
                    ...
                    <div class="dropdown-menu-header-inner bg-primary">
                        ...
                        <div class="menu-header-content">
                            <div class="avatar-icon-wrapper avatar-icon-lg">
                                <div class="avatar-icon rounded btn-hover-shine"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/12.jpg" alt="Avatar 5"></div>
                            </div>
                            <div>
            ...
            <div class="card-shadow-primary profile-responsive card-border mb-3 card">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-focus">
                        <div class="menu-header-image opacity-3" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/dropdown-header/city4.jpg');"></div>
                        <div class="menu-header-content btn-pane-right">
                            <div class="avatar-icon-wrapper mr-2 avatar-icon-xl">
                                <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/12.jpg" alt="Avatar 5"></div>
                            </div>
                            <div>
            ...
            <div class="card-shadow-primary profile-responsive card-border mb-3 card">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-info">
                        ...
                        <div class="menu-header-content btn-pane-right">
                            <div class="avatar-icon-wrapper mr-2 avatar-icon-xl">
                                <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/7.jpg" alt="Avatar 5"></div>
                            </div>
                            <div>
                            ...
                            <li class="list-group-item">
                                <div class="widget-content">
                                    <div class="text-center">
                                        ...
                                        <h5><span class="pr-2"><b class="text-danger">12</b> new leads,</span><span><b class="text-success">$56,24</b> in sales</span></h5>
                                    </div>
                                </div>
                            </li>
                            <li class="p-0 list-group-item">
                    ...
                    <div class="dropdown-menu-header-inner bg-dark">
                        <div class="menu-header-content">
                            <div class="avatar-icon-wrapper mb-3 avatar-icon-xl">
                                <div class="avatar-icon"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/6.jpg" alt="Avatar 5"></div>
                            </div>
                            <div>
                ...
                <div class="p-3">
                    ...
                    <ul class="rm-list-borders list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left mr-3"><img width="42" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/5.jpg" alt=""></div>
                                    <div class="widget-content-left">
                        ...
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left mr-3"><img width="42" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/4.jpg" alt=""></div>
                                    <div class="widget-content-left">
                        ...
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left mr-3"><img width="42" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/2.jpg" alt=""></div>
                                    <div class="widget-content-left">
                        ...
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left mr-3"><img width="42" class="rounded-circle" src="<?= base_url('themes/uigniter'); ?>/images/avatars/3.jpg" alt=""></div>
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Katerina Hutchings</div>
                                        <div class="widget-subheading">Group UIgniter</div>
                                    </div>
                                    <div class="widget-content-right">
                                        <div class="font-size-xlg text-muted">
                                            <small class="opacity-5 pr-1">$</small>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            ...
            <div class="card-hover-shadow card-border mb-3 card">
                    ...
                    <div class="dropdown-menu-header-inner bg-warning">
                        <div class="menu-header-content">
                            <div><a href="javascript:void(0);" class="avatar-icon-wrapper btn-hover-shine avatar-icon-xl">
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/3.jpg" alt="Avatar 5"></div>
                                </a></div>
                            <div>
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">Since the 1500s, when an unknown printer took a galley of type and scrambled.</p>
                </div>
