            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>
                            Chat
                            <div class="page-title-subheading">UIgniter HTML Bootstrap 4 Dashboard Template</div>
                        </div>
                    </div>
                    ...
                    <div class="app-inner-layout__top-pane">
                        <div class="pane-left">
                            ...
                            <div class="avatar-icon-wrapper mr-2">
                                ...
                                <div class="avatar-icon avatar-icon-xl rounded"><img width="82" src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt=""></div>
                            </div>
                            ...
                            <div>
                                <div class="avatar-icon-wrapper mr-1">
                                    ...
                                    <div class="avatar-icon avatar-icon-lg rounded">
                                        <img src="<?= base_url('themes/uigniter'); ?>/images/avatars/2.jpg" alt=""></div>
                                </div>
                            </div>
                            <div>
                        ...
                        <li class="text-center p-2 nav-item">
                            <div class="avatar-wrapper avatar-wrapper-overlap">
                                <div class="avatar-icon-wrapper">
                                    ...
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/5.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/10.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/7.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/8.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/1.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/2.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/3.jpg" alt=""></div>
                                </div>
                                <div class="avatar-icon-wrapper">
                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                    <div class="avatar-icon rounded"><img src="<?= base_url('themes/uigniter'); ?>/images/avatars/4.jpg" alt=""></div>
                                </div>
