                        ...
                        <div class="modal-dialog w-100">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="h5 modal-title">Welcome,<h6 class="mt-1 mb-0 opacity-8"><span>It only takes a <span class="text-success">few seconds</span> to create your account</span></h6>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                        ...
                                        <li class="nav-item">
                                            <a role="tab" class="nav-link" href="<?= base_url('uigniter/register'); ?>">
                                                <span>Register</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a role="tab" class="nav-link active" href="<?= base_url('uigniter/register_boxed') ?>">
                                    ...
                                    <h6 class="mb-0">Already have an account? <a href="<?= base_url('uigniter/login_boxed'); ?>" class="text-primary">Sign in</a> | <a href="<?= base_url('uigniter/forgot_password_boxed'); ?>" class="text-primary">Recover Password</a></h6>
                                </div>
