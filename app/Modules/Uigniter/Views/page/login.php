                            ...
                            <div class="slick-slider">
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('<?= base_url('themes/uigniter'); ?>/images/originals/citydark.jpg');"></div>
                                        <div class="slider-content">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                ...
                                <li class="nav-item">
                                    <a role="tab" class="nav-link active" href="<?= base_url('uigniter/login'); ?>">
                                        <span>Login</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a role="tab" class="nav-link" href="<?= base_url('uigniter/login_boxed') ?>">
                            ...
                            <h6 class="mt-3">No account? <a href="<?= base_url('uigniter/register') ?>" class="text-primary">Sign up now</a></h6>
                            ...
                            <div>
                                <form class="">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto"><a href="<?= base_url('uigniter/forgot_password') ?>" class="btn-lg btn btn-link">Recover Password</a>
