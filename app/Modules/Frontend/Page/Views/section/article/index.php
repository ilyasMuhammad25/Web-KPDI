    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-8 col-lg-6 text-center text-lg-left">
                <h1 class="alt-font text-corporate-primary font-weight-500 no-margin-bottom sm-margin-10px-bottom d-inline-block">Artikel</h1>
                <span class="alt-font text-medium d-block d-md-inline-block">Dokumentasi Koleksi Artikel Karya Penulis Wanita</span>
            </div>
                ...
                <div class="row">
                    <span class="alt-font font-weight-500 text-large text-extra-dark-gray d-block margin-25px-bottom padding-15px-left">
                        <?php if(!empty($keyword)): ?>
                            Pencarian <i>"<?=$keyword?>"</i>, ditemukan <?=$count_articles?> artikel.
                        <?php else:?>
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.<?=$i?>s">
                                <div class="blog-post">
                                    <div class="blog-post-image bg-dark-red">
                                        <a href="<?=base_url('artikel/'.$row->slug)?>"><img src="<?=base_url('uploads/article/'.$row->file_image)?>" alt=""></a>
                                    </div>
                                    <div class="post-details bg-white text-center padding-3-rem-all xl-padding-2-rem-all">
                                        <a href="<?=base_url('artikel/'.$row->slug)?>" class="blog-category text-fast-blue margin-15px-bottom text-medium font-weight-500 letter-spacing-1px text-uppercase"><?=$row->author?></a>
                                        <a href="<?=base_url('artikel/'.$row->slug)?>" class="alt-font text-extra-dark-gray text-extra-dark-gray-hover text-large line-height-26px d-block margin-20px-bottom"><?=$row->title?></a>
                                        <a href="<?=base_url('artikel/'.$row->slug)?>" class="alt-font text-uppercase text-extra-small letter-spacing-1px d-block"><?=$row->created_at?></a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
