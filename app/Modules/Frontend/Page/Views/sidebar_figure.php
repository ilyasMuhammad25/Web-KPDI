...
$figureModel = new \App\Modules\Backend\Figure\Models\FigureModel();
$categories = $figureModel
	->select('c_references.*')
	->select('count(t_figure.category_id) as total')
	->join('c_references','c_references.id = t_figure.category_id','inner')
...
<aside class="col-12 col-xl-3 offset-xl-1 col-lg-4 col-md-7 blog-sidebar lg-padding-4-rem-left md-padding-15px-left">
    ...
    <div class="margin-5-rem-bottom xs-margin-35px-bottom wow animate__fadeIn">
        ...
        <ul class="list-style-07 list-unstyled">
            ...
            <li><a href="<?=base_url('tokoh-wanita?slug='.$row->slug)?>"><?=$row->name?></a><span class="item-qty"><?=$row->total ?? 0?></span></li>
            <?php endforeach;?>
        </ul>
    </div>
    <!-- <div class="margin-5-rem-bottom xs-margin-35px-bottom wow animate__fadeIn">
