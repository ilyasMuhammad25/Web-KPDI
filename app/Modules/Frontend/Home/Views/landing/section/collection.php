				...
				<div class="tab-pane fade show active" id="card" role="tabpanel" aria-labelledby="card-tab">
					<div class="version">
						...
						<div class="v_middle">
							...
							<p class="pl-3">Buku ini disusun untuk memudahkan anak belajar berhitung dengan cara yang menyenangkan. Aktivitas-aktivitas disajikan dengan sederhana dan menarik. 
