...
<div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?= lang('Sirkulasi.module') ?> 
                    <div class="page-title-subheading"><?= lang('Sirkulasi.info.list_all') ?>  <?= lang('Sirkulasi.pengembalian') ?> </div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i><?= lang('Sirkulasi.label.table') ?> <?= lang('Sirkulasi.pengembalian') ?> 
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if(is_allowed('sirkulasi/create')):?>
                    <a href="<?= base_url('sirkulasi/createpengembalian') ?>" class=" btn btn-success" title=""><i class="fa fa-plus"></i> <?= lang('Sirkulasi.action.add') ?> <?= lang('Sirkulasi.pengembalian') ?> </a>
                <?php endif;?>
            </div>
        </div>
        <div class="card-body">
            ...
            <table style="width: 100%;" id="tbl_sirkulasis" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><?= lang('Sirkulasi.field.noanggota') ?></th>
                        <th><?= lang('Sirkulasi.field.nobarcode') ?></th>
                ...
                <tbody>
                    <?php foreach ($sirkulasis as $row) : ?>
                        <tr>
                            ...
                            <td width="200">
                                <?= _spec($row->noanggota); ?> <br>
                            </td>
                            <td><?= _spec($row->nobarcode); ?></td>
