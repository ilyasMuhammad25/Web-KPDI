...
<div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?= lang('Sirkulasi.module') ?> 
                    <div class="page-title-subheading"><?= lang('Sirkulasi.info.list_all') ?>  <?= lang('Sirkulasi.peminjaman') ?> </div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i><?= lang('Sirkulasi.label.table') ?> <?= lang('Sirkulasi.peminjaman') ?> 
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if(is_allowed('sirkulasi/create')):?>
                    <a href="<?= base_url('sirkulasi/create') ?>" class=" btn btn-success" title=""><i class="fa fa-plus"></i> <?= lang('Sirkulasi.action.add') ?> <?= lang('Sirkulasi.peminjaman') ?> </a>
                <?php endif;?>
            </div>
        </div>
        <div class="card-body">
