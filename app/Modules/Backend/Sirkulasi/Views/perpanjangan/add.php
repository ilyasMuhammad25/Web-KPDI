					...
					<div class="card-body">
						<div class="tab-content">
							<div class="tab-pane active show" id="tab1" role="tabpanel">
								<form name="form_sirkulasis" id="form_sirkulasis" action="<?= base_url('sirkulasi/cart_insert/0?member_no='.$member_no.'&slug=perpanjangan') ?>">
											...
											<tbody>
												<?php foreach ($sirkulasis as $row) : ?>
													<tr>
														...
														<td width="35">
															<a href="<?= base_url('sirkulasi/proses_perpanjangan/'.$row->id) ?>" data-toggle="tooltip" data-placement="top" title="Proses Perpanjangan" class="btn btn-primary show-data"><i class="fa fa-save"> </i></a>
														</td>
													</tr>
												<?php endforeach; ?>
											</tbody>
							...
							<div class="tab-pane show" id="tab2" role="tabpanel">
								<form method="post" action="<?=base_url('sirkulasi/create_perpanjangan')?>">
									<input type="hidden" name="member_no" value="<?=$member_no?>">
									<input type="hidden" name="slug" value="perpanjangan">
									<div class="table-responsive">
										<table style="width: 100%;" id="tbl_carts" class="table table-hover table-striped table-bordered">
											...
											<tbody>
												<?php $cart_name = 'perpanjangan_'.$member_no; ?>
...
<script>
	...
	$('#add_to_cart').click(function() {
		...
		// Swal.fire({
        //     title: 'Anda yakin?',
        //     text: "Semua Koleksi yang terpilih akan ditambahkan ke Keranjang Perpanjangan!",
        //     type: 'warning',
