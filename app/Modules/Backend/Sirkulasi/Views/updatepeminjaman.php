...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?= lang('Sirkulasi.action.update') ?> <?= lang('Sirkulasi.datapeminjaman') ?>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form <?= lang('Sirkulasi.action.update') ?> <?= lang('Sirkulasi.datapeminjaman') ?>
            </div>
            <div class="card-body">
