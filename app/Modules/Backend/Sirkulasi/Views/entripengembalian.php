...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?= lang('Sirkulasi.action.add') ?> <?= lang('Sirkulasi.pengembalian') ?>
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page"><?= lang('Sirkulasi.action.add') ?> <?= lang('Sirkulasi.pengembalian') ?></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form <?= lang('Sirkulasi.action.add') ?> <?= lang('Sirkulasi.pengembalian') ?>
            </div>
            <div class="card-body">
                  <div id="infoMessage"><?= $message ?? ''; ?></div>
                  <?= get_message('message'); ?>

                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('sirkulasi/createpengembalian'); ?>">
                        <div class="form-row">
                              <div class="col-md-9">
