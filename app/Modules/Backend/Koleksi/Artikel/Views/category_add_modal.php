                    ...
                    <div class="form-row">
                        <div class="col-md-8">
                            <div class="position-relative form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" id="frm_create_name" name="Title"
                                        placeholder="Judul" value="<?= set_value('Title'); ?>" />
                        ...
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" id="frm_create_name" name="Creator"
                                        placeholder="Kreator" value="<?= set_value('Creator'); ?>" />
                                    <small class="info help-block text-muted">Nama Kategori Menu</small>
...
$('#frm_create').submit(function(event) {
    ...
    $.ajax({
            url: '<?= base_url('api/artikel/category_create') ?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
