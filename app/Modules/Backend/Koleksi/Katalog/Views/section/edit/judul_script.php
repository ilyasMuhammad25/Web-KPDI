	...
	$(document).on('click', '.title_varian_btn_add', function() {
		...
		$('#'+tbody).append(`
			<div class="form-group title_varian_wrapper">
				<div class="input-group">
					<input type="text" class="form-control" name="title_varian[`+index+`]" placeholder="Variasi Bentuk Judul" value="">
	...
	$(document).on('click', '.title_original_btn_add', function() {
		...
		$('#'+tbody).append(`
			<div class="form-group title_original_wrapper">
				<div class="input-group">
					<input type="text" class="form-control" name="title_original[`+index+`]" placeholder="Judul Asli" value="">
