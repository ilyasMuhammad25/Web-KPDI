<?php 
	$author_arr = explode(";",($catalog->author));
	$author_a = $author_arr[0];
	$author_b = $author_arr[1]??'';
	$author_c = $author_arr[2]??'';
?>
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<input type="text" class="form-control author-input" id="author-input" name="author[100]" placeholder="Tajuk Pengarang Utama" value="<?=get_catalog_value($catalog->id,'100','$a')?>">
									...
									<div class="row">
										...
										<div class="col-md-8">
											<div class="input-group">
												<input type="text" class="form-control" name="author_additional[input][]" placeholder="Tajuk Pengarang Tambahan" value="<?=get_catalog_value($catalog->id,'700','$a')?>">
