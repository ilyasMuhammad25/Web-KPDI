									...
									<div class="row">
										<div class="col-md-12">
											<div class="input-group">
												<input type="text" class="form-control" name="notes[input][]" placeholder="Catatan" value="<?=get_catalog_value($catalog->id,'520','$a')?>">
												<div class="input-group-append">
													<button class="btn btn-sm btn-light notes_btn_add" type="button" data-tbody="notes_tbody"><i class="fa fa-plus m-1"></i></button>
												</div>
											</div>
										</div>
									</div>
