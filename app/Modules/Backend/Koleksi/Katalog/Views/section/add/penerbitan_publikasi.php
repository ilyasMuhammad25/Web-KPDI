						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="publisher[a]" placeholder="Tempat Terbit" value="">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="publisher" class="col-form-label">Penerbit</label>
									<input type="text" class="form-control" name="publisher[b]" placeholder="Penerbit" value="">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="publish_year" class="col-form-label">Tahun</label>
									<input type="text" class="form-control" name="publisher[c]" placeholder="Tahun Terbit" value="">
								</div>
							</div>
						</div>
