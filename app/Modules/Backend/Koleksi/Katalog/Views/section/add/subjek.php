				...
				<div data-parent="#accordion5" id="collapse5" class="collapse" style="">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="class_ddc" placeholder="No. Kelas DDC" value="">
									...
									<div id="call_no_tbody">
										<div class="form-group call_no_wrapper">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="call_no[]" placeholder="No. Panggil" value="">
