						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<div>
										<input type="text" class="form-control" name="serial_edition" placeholder="<?=lang('Eksemplar.field.Edisiserial')?> " value='<?=set_value('serial_edition', '')?>' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<div>
										<input type="date" class="form-control" name="serial_edition_date" value='<?=set_value('serial_edition_date', '')?>' placeholder="<?=lang('Eksemplar.field.Tanggalserial')?> " />
									</div>
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<div>
										<input type="text" class="form-control" name="bahan_sertaan" value='<?=set_value('bahan_sertaan', '')?>' placeholder="<?=lang('Eksemplar.field.Bahansertaan')?> " />
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<div>
										<input type="text" class="form-control" name="other_info" placeholder="<?=lang('Eksemplar.field.Keteranganlain')?> " />
									</div>
								</div>
							</div>
						</div>
