...
class Anggota extends Migration
{
	...
	{
		// t_anggota
		$this->forge->dropTable('t_anggota', true);
		$this->forge->addField([
			...
			'ref_identitas' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_jeniskelamin' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_pendidikan' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_pekerjaan' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_jenisanggota' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_perkawinan' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_agama' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_unitkerja' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_fakultas' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
			'ref_jurusan' 	=> ['type' => 'INT','constraint' => 11,'null' => true,],
