<div class="mb-3 card">
	<div class="card-header-tab card-header">
		...
		<ul class="nav">
			<li class="nav-item"><a data-toggle="tab" href="#tab1" class="nav-link active show">Keanggotaan</a></li>
			<li class="nav-item"><a data-toggle="tab" href="#tab2" class="nav-link show">Alamat</a></li>
			<li class="nav-item"><a data-toggle="tab" href="#tab3" class="nav-link show">Tambahan</a></li>
		</ul>
	</div>
	<div class="card-body">
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_identitas" id="ref_identitas" tabindex="-1" aria-hidden="true" placeholder="<?= lang('Anggota.field.Jenisidentitas') ?>">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_IdentityNo" name="IdentityNo" placeholder="Nomor identitas" value="<?= set_value('IdentityNo',$anggota->IdentityNo); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="date" class="form-control" id="frm_create_DateOfBirth" name="DateOfBirth" placeholder="Tempat Lahir" value="<?= set_value('DateOfBirth',$anggota->DateOfBirth); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_perkawinan" id="ref_perkawinan" tabindex="-1" aria-hidden="true">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_agama" id="ref_agama" tabindex="-1" aria-hidden="true">
											<option value="" disabled selected><?= lang('Anggota.field.Agama') ?></option>
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_jeniskelamin" id="ref_jeniskelamin" tabindex="-1" aria-hidden="true" placeholder="<?= lang('Anggota.field.Jeniskelamin') ?>">
							...
							<div class="form-row">
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_NoHp" name="NoHp" placeholder="Nomor Handphone" value="<?= set_value('NoHp',$anggota->NoHp); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="email" class="form-control" id="Email" name="Email" placeholder="Email" value="<?= set_value('Email',$anggota->Email); ?>" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_Statusanggota" id="ref_Statusanggota" tabindex="-1" aria-hidden="true">
											<option value="" disabled selected>
								...
								<div class="col-md-6">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_BiayaPendaftaran" name="BiayaPendaftaran" placeholder=<?= lang('Anggota.field.Biayapendaftaran') ?> value="<?= set_value('BiayaPendaftaran',$anggota->BiayaPendaftaran); ?>" />
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_unitkerja" id="ref_unitkerja" tabindex="-1" aria-hidden="true">
							...
							<div class="form-row">
								<div class="col-md-12">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_Address" name="Address" placeholder="Alamat" value="<?= set_value('Address',$anggota->Address); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
										...
										<div>
											<select class="form-control select2" name="Provincy" id="Provincy" tabindex="-1" aria-hidden="true" style="width:100%">
												...
												<?php foreach(get_dropdown('m_propinsi') as $row):?>
													<option value="<?= $row->text ?>" <?=($row->text == $anggota->Provincy) ? 'selected':''?>><?= $row->text?></option>
												<?php endforeach;?>
											</select>
										</div>
									</div>
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_City" name="City" placeholder="<?= lang('Anggota.field.city') ?>" value="<?= set_value('City',$anggota->City); ?>" />
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_kecamatan" name="kecamatan" placeholder="Kecamatan" value="<?= set_value('Kecamatan',$anggota->Kecamatan); ?>" />
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_kelurahan" name="kelurahan" placeholder="Kelurahan" value="<?= set_value('Kelurahan',$anggota->Kelurahan); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_RT" name="RT" placeholder="RT" value="<?= set_value('RT',$anggota->RT); ?>" />
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										...
										<div>
											<input type="text" class="form-control" id="frm_create_RW" name="RW" placeholder="RW" value="<?= set_value('RW',$anggota->RW); ?>" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="position-relative form-group">
										<label for="name"><?=lang('Anggota.field.provinsi')?></label>
										<div>
											<input type="text" class="form-control" id="frm_create_Provincy" name="Provincy" placeholder="<?=lang('Anggota.field.provinsi')?>" value="<?= set_value('Provincy',$anggota->Provincy); ?>" />
										</div>
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_unitkerja" id="ref_unitkerja" tabindex="-1" aria-hidden="true">
											<?php foreach (get_ref('ref_unitkerja') as $row) : ?>
											<option value="<?= $row->id ?>" <?=($row->id == $anggota->ref_unitkerja) ? 'selected':''?>><?= $row->name ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="position-relative form-group">
										...
										<select class="form-control" name="ref_pendidikan" id="ref_pendidikan" tabindex="-1" aria-hidden="true">
											<?php foreach (get_ref('ref_pendidikan') as $row) : ?>
											<option value="<?= $row->id ?>" <?=($row->id == $anggota->ref_pendidikan) ? 'selected':''?>><?= $row->name ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
