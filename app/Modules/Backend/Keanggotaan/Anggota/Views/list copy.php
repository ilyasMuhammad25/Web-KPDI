                    ...
                    <tr>
                        ...
                        <td width="130">
                            ...
                            <?php if(is_allowed('anggota/delete')):?>
                                    <a href="<?= base_url('anggota/delete/' . $row->id); ?>" data-toggle="tooltip" data-placement="top" title="Hapus  rud" class="btn btn-xs btn-danger remove-data"><i class="pe-7s-trash font-weight-bold"> </i></a>
                                <?php endif;?>
                        </td>
                    </tr>
                    <?php endforeach;?>
