...
<div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?= lang('Anggota.module') ?> 
                    <div class="page-title-subheading"><?= lang('Anggota.info.list_all') ?>  <?= lang('Anggota.module') ?> </div>
                </div>
            </div>
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('anggota') ?>"><i class="fa fa-home"></i> <?= lang('Anggota.label.home') ?></a></li>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i><?= lang('Anggota.label.table') ?> <?= lang('Anggota.module') ?> 
            ...
            <table style="width: 100%;" id="tbl_anggotas" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><?= lang('Anggota.field.description') ?></th>
                        <th><?= lang('Anggota.field.sort') ?></th>
                ...
                <tbody>
                    <?php foreach ($anggotas as $row) : ?>
                        <tr>
                            ...
                            <td width="50">
                                <input type="checkbox" class="apply-status" data-href="<?= base_url('anggota/apply_status'); ?>" data-field="active" data-id="<?=$row->id?>" <?= ($row->active == 1) ? 'checked' : '' ?> data-toggle="toggle" data-onstyle="success">
                            </td>
                            <td width="100">
                            ...
                            <td width="35">
                                ...
                                <?php if(is_allowed('anggota/update')):?>
                                    <a href="<?= base_url('anggota/edit/' . $row->id) ?>" data-toggle="tooltip" data-placement="top" title="Ubah Anggota" class="btn btn-xs btn-warning mb-1 show-data"><i class="pe-7s-note font-weight-bold"> </i></a>
                                <?php endif;?>
                                <?php if(is_allowed('anggota/delete')):?>
                                    <a href="javascript:void(0);" data-href="<?= base_url('anggota/delete/' . $row->id); ?>" data-toggle="tooltip" data-placement="top" title="Hapus  rud" class="btn btn-xs btn-danger remove-data"><i class="pe-7s-trash font-weight-bold"> </i></a>
                                <?php endif;?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
