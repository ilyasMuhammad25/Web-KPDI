                ...
                <tbody>
                    <?php foreach ($sumbangans as $row) : ?>
                        <tr>
                            ...
                            <td width="50">
                                <input type="checkbox" class="apply-status" data-href="<?= base_url('sumbangan/apply_status'); ?>" data-field="active" data-id="<?=$row->id?>" <?= ($row->active == 1) ? 'checked' : '' ?> data-toggle="toggle" data-onstyle="success">
                            </td>
                            <td width="100">
                            ...
                            <td width="35">
                                ...
                                <?php endif;?>
                                <?php if(is_allowed('sumbangan/update')):?>
