...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page"><?= lang('Sumbangan.action.add') ?> <?= lang('Sumbangan.module') ?></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form <?= lang('Sumbangan.action.add') ?> <?= lang('Sumbangan.module') ?>
            </div>
            <div class="card-body">
                        ...
                        <div class="form-row">
                              ...
                              <div class="col-md-5">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="<?= lang('Sumbangan.field.name') ?> " value="<?= set_value('name'); ?>" />
                              ...
                              <div class="col-md-3">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                ...
                                                <small class="info help-block text-muted"><?= lang('Sumbangan.field.sort') ?>  Sumbangan</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
