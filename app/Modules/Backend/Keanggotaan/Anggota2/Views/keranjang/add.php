...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form <?= lang('Anggota.action.add') ?> <?= lang('Anggota.module') ?>
            </div>
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('anggota/create'); ?>">
                        <div class="form-row">
                              <div class="col-md-9">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="<?= lang('Anggota.field.name') ?> " value="<?= set_value('name'); ?>" />
                              ...
                              <div class="col-md-3">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="number" class="form-control" id="frm_create_sort" name="sort" placeholder="<?= lang('Anggota.field.sort') ?> " value="<?= set_value('sort') ?>" />
                                                <small class="info help-block text-muted"><?= lang('Anggota.field.sort') ?>  Anggota</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div class="form-group">
                              ...
                              <div>
                                    <textarea id="frm_create_description" name="description" placeholder="<?= lang('Anggota.field.description') ?> " rows="2" class="form-control autosize-input" style="min-height: 38px;"><?= set_value('description') ?></textarea>
                              </div>
                        </div>
