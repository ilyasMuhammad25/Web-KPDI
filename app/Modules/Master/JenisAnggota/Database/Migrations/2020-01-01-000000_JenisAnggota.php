...
namespace JenisAnggota\Database\Migrations;

use CodeIgniter\Database\Migration;

class JenisAnggota extends Migration
{
	public function up()
	{
		// t_jenisanggota
		$this->forge->dropTable('t_jenisanggota', true);
		$this->forge->addField([
		...
		$this->forge->createTable('t_jenisanggota');
	}
