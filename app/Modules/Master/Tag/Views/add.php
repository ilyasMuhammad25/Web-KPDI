...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?=lang('Tag.action.add')?> <?=lang('Tag.module')?> <div class="page-title-subheading"><?=lang('Tag.form.complete_the_data')?>.</div>
                </div>
            </div>
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page"><?=lang('Tag.action.add')?> <?=lang('Tag.module')?></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header">
            <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form <?=lang('Tag.action.add')?> <?=lang('Tag.module')?>
        </div>
        <div class="card-body">
            <div id="infoMessage"><?=$message ?? ''?></div> <?=get_message('message')?>
			<form id="frm_create" method="post" action="<?=base_url('tag/create')?>" onsubmit="return validateForm()">
                <div class="form-row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="frm_create_tag" name="tag" placeholder="<?=lang('Tag.field.tag')?> " value="<?=set_value('tag')?>" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="<?=lang('Tag.field.name')?> " value="<?=set_value('name')?>" required/>
                            </div>
                        </div>
                    </div>
					<div class="col-md-4">
                        <div class="position-relative form-group">
							...
							<div>
								<input type="number" class="form-control" id="frm_create_length" min="1" max="255" name="length"
									placeholder="<?=lang('Tag.field.length')?> " value="<?=set_value('length', 1)?>" />
							</div>
                        </div>
                    </div>
                </div>
				...
				<div class="form-row">
					<div class="col-md-12">
                        <div class="position-relative form-group">
							...
							<div>
								<textarea id="frm_create_description" name="description" placeholder="<?=lang('Tag.field.description')?> " rows="2" class="form-control autosize-input" style="min-height: 38px;"><?=set_value('description')?></textarea>
							</div>
                        </div>
                    </div>
				</div>
					...
					<div class="col">
						<div class="form-group" style="display: inline-block">
							<div>
								...
								<input type="checkbox" class="form-control" name="fixed" value="1"> 
							</div>
						</div>
                    </div>
					<div class="col">
						<div class="form-group" style="display: inline-block">
							<div>
								...
								<input type="checkbox" class="form-control" name="enabled" value="1">
							</div>
						</div>
                    </div>
					<div class="col">
						<div class="form-group" style="display: inline-block">
							<div>
								...
								<input type="checkbox" class="form-control" name="repeatable" value="1">
							</div>
						</div>
                    </div>
					<div class="col">
						<div class="form-group" style="display: inline-block">
							<div>
								...
								<input type="checkbox" class="form-control" name="mandatory" value="1">
							</div>
						</div>
                    </div>
					<div class="col">
						<div class="form-group" style="display: inline-block">
							<div>
								...
								<input type="checkbox" class="form-control" name="customable" value="1">
							</div>
						</div>
                    </div>
				</div>
