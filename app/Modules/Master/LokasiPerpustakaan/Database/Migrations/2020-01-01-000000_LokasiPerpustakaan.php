...
namespace LokasiPerpustakaan\Database\Migrations;

use CodeIgniter\Database\Migration;

class LokasiPerpustakaan extends Migration
{
	public function up()
	{
		// m_lokasiperpustakaan
		$this->forge->dropTable('m_lokasiperpustakaan', true);
		$this->forge->addField([
		...
		$this->forge->createTable('m_lokasiperpustakaan');
	}
